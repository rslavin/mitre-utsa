...
html_top("Hash-based Registration (Better)");

// input form
echo '
<form method="post" action="betterReg.php">
    <div>
...
if (!empty($_POST['submit'])) {
    ...
    $query = "INSERT INTO users_more_secure (username, password, first_name, last_name) VALUES (?, ?, ?, ?)";
